...
import { Menu, X, RefreshCw, Plus, Key, Search, History } from "lucide-react";
...
const FloatingMenu: React.FC = () => {
  ...
  const [focusedField, setFocusedField] = useState<"owner" | "repo" | null>(
    null,
  );
                        ...
                        repoSuggestions.length > 0 && (
                          ...
                          >
                            {repoSuggestions.map((suggestion) => (
                              ...
                              >
                                <span>{suggestion}</span>
                                {recentRepos.includes(suggestion) && (
                                  <History
                                    size={10}
                                    className="text-neutral-600"
                                  />
